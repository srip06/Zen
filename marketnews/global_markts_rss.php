 	...
 	include "./zamRSS.php";
		...
		$rss->cache_time = 1200;
          ...
          if ($rs = $rss->get('http://www.moneycontrol.com/rss/internationalmarkets.xml')) {
			...
			echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color=#800000 style=\"position:absolute; left:0px; top:-3px;\"><b>GLOBAL MARKET NEWS</b></font>
            <Marquee style=\"position:absolute; left:-20px;\" class=marquee direction=up onMouseOver=this.stop(); onMouseOut=this.start(); scrollamount=2>
            <ul style=\"list-style-image: url(images/cal_forward.gif);\">\n";
