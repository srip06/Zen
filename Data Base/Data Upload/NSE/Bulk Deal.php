...
$today = date('d-m-Y');
$sourceURLOriginal = "http://www.nseindia.com/content/equities/bulk.csv";
// Destination folder
...
$stringData = "Successfully Uploaded bulk deal file\n";
fwrite($fh, $stringData);
}
 else
{
$fh = fopen($myFile, 'a') or die("can't open file");
$stringData =  "can't Uploaded bulk deal file\n";
fwrite($fh, $stringData);
}
fclose($fh);
?>
