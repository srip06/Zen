...
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
	<div style="position:absolute; top:19px; left:120px; color:green; font-size:12px"><b><?php echo $today; ?></b></div>
...
<body>
<hr width="180" style="position:absolute; top:36px;  cursor:text;" align="left" color="green">
...
<a  href="bsegr.php?id=bseblue" id="bseblue" name="bseblue" style="position:absolute; top:16px;  cursor:hand;" target="graph" onclick="javascript:research('bseblue');">
</a>
<a  href="nsegr.php?id=nseblue" id="nseblue" name="nseblue" style="position:absolute; top:16px;  left:54px; cursor:hand;" target="graph" onclick="javascript:research('nseblue');">
</a>
