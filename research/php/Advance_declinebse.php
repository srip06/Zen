...
$sel_date = $_GET['fromdate'];
?>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<div style="position:absolute; top:19px; left:538px; color:green; font-size:13px"><b>Advance Decline</b></div>
...
<form method="get" action="Advance_declinebse.php?id=<?php echo $exchange; ?> &fromdate=<?php echo $sel_date; ?>"   name="form1" id="form1">
<table border="0" style="color:#1B68AE; font-weight:bold;" cellspacing="1" cellpadding="3" align="left" style="font-size:13px;">
  <tr>
<td>Date</td>
        <td><input id="fromdate" name="fromdate" type="text" size="9" ></td>
 ...
 if (isset($_GET['page']) && is_numeric($_GET['page']))
      ...
      //  }
       ...
       // }
        ...
        {
        $i = $show_page - 1;
        $prev = "<a href=\"Advance_declinebse.php?page=$i&id=$exchange&fromdate=$sel_date\"><strong>Prev |</strong></a>";
        $first = "<a href=\"Advance_decline.php?page=1&id=$exchange&fromdate=$sel_date\"><strong>First |</strong></a>";
        }
        else {
...
if ($show_page < $total_pages) {
     $i = $show_page + 1;
     $next = "<a href=\"Advance_decline.php?page=$i&id=$exchange&fromdate=$sel_date\"><strong>Next |</strong></a>";
     $last = "<a href=\"Advance_decline.php?page=$total_pages&id=$exchange&fromdate=$sel_date\"><strong>Last |</strong></a>";
}
else {
...
echo "<tr>";
echo "<td bgcolor=\"CDE9FB\" align=\"center\" style=\"font-size:14;\"><b>Industry</b></td> ";
echo "<td bgcolor=\"CDE9FB\" align=\"center\" style=\"font-size:14;\"><b>Advance</b></td> ";
echo "<td bgcolor=\"CDE9FB\" align=\"center\" style=\"font-size:14;\"><b>Decline</b></td> ";
echo "<td bgcolor=\"CDE9FB\" align=\"center\" style=\"font-size:14;\"><b>Unchange</b></td> ";
echo "</tr>";
...
for ($i = $start; $i < $end; $i++)
        {
                ...
                echo "<td  bgcolor=\"F8F8F8\" align=\"left\" style=\"color:#004040\">" . mysql_result($result, $i, 'Industry') . '</td>';
                echo "<td  bgcolor=\"F8F8F8\" align=\"left\" style=\"color:#004040\">" . mysql_result($result, $i, 'Advance') . '</td>';
                echo "<td  bgcolor=\"F8F8F8\" align=\"left\" style=\"color:#004040\">" . mysql_result($result, $i, 'Decline') . '</td>';
                echo "<td  bgcolor=\"F8F8F8\" align=\"left\" style=\"color:#004040\">" . mysql_result($result, $i, 'Unchange') . '</td>';
                echo "</tr>";
        }
         echo "</table><br>";
  if(empty($show_page))
