...
<!-- <!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd"> -->
	<div style="position:absolute; top:19px; left:588px; color:green; font-size:13px"><b>Week52High</b></div>
...
<hr width="659" style="position:absolute; top:34px;" align="left" color="green">
  <![endif]-->
    <!--[if gte IE 8]>
<hr style="position:absolute; top:26px;" width="670" align="left" color="green">
  <![endif]-->
<div id="research1" name="research1" style="position:absolute; height:39px; width:662px; top:37px;">
<form action="week52highbse.php?id=<?php echo $exchange; ?>&mymarkettype=<?php echo $sel_martype; ?>&industry=<?php echo $sel_industry; ?>&sector=<?php echo $sel_sector; ?>" method="get"  name="form1" id="form1">
...
if(isset($_POST))
{
	...
	$sql="call sp_52_week_high_bse('".$exchange."','".$sel_martype."','".$sel_industry."','".$sel_sector."')";
...
if (isset($_GET['page']) && is_numeric($_GET['page']))
      ...
      $prev = "<a href=\"week52highbse.php?page=$i&id=$exchange&mymarkettype=$sel_martype&industry=$sel_industry&sector=$sel_sector\"><strong>Prev |</strong></a>";
    $first = "<a href=\"week52highbse.php?page=1&id=$exchange&mymarkettype=$sel_martype&industry=$sel_industry&sector=$sel_sector\"><strong>First |</strong></a>";
        }
        else {
...
if ($show_page < $total_pages) {
  ...
  $next = "<a href=\"week52highbse.php?page=$i&id=$exchange&mymarkettype=$sel_martype&industry=$sel_industry&sector=$sel_sector\"><strong>Next |</strong></a>";
  $last = "<a href=\"week52highbse.php?page=$total_pages&id=$exchange&mymarkettype=$sel_martype&industry=$sel_industry&sector=$sel_sector\"><strong>Last |</strong></a>";
}
else {
...
echo "<td bgcolor=\"CDE9FB\" align=\"center\" style=\"font-size:14;\"><b>High 52 Week</b></td> ";
	...
	for ($i = $start; $i < $end; $i++)
        {
               ...
               // $nseid=mysql_result($result, $i, 'id');
                ...
                echo "<td  bgcolor=\"F8F8F8\" align=\"left\" style=\"color:#004040\">" . mysql_result($result, $i, 'High_week_52') . '</td>';
