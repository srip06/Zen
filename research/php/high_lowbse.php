...
<form action="high_lowbse.php?id=<?php echo $exchange; ?>&highlow=<?php echo $sel_highlow; ?>" method="get" name="form1" id="form1">
...
if(isset($_GET))
{
 ...
 if (isset($_GET['highlow']))
	...
	$sql="call sp_close_price_bse2('".$sel_highlow."')";
 ...
 if (isset($_GET['page']) && is_numeric($_GET['page']))
      ...
      //  }
       ...
       // }
        ...
        {
        $i = $show_page - 1;
        $prev = "<a onMouseOver=\"window.status=''; return true;\"  href=\"high_lowbse.php?page=$i&id=$exchange&highlow=$sel_highlow\"><strong>Prev |</strong></a>";
        $first = "<a onMouseOver=\"window.status=''; return true;\" href=\"high_lowbse.php?page=1&id=$exchange&highlow=$sel_highlow\"><strong>First |</strong></a>";
        }
        else {
...
if ($show_page < $total_pages) {
     $i = $show_page + 1;
     $next = "<a onMouseOver=\"window.status=''; return true;\"  href=\"high_lowbse.php?page=$i&id=$exchange&highlow=$sel_highlow\"><strong>Next |</strong></a>";
     $last = "<a onMouseOver=\"window.status=''; return true;\"  href=\"high_lowbse.php?page=$total_pages&id=$exchange&highlow=$sel_highlow\"><strong>Last |</strong></a>";
}
else {
