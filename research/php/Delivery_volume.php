...
<form action="Delivery_volume.php?id=<?php echo $exchange; ?>&mymarkettype=<?php echo $sel_martype; ?>&industry=<?php echo $sel_industry; ?>&sector=<?php echo $sel_sector; ?>&mytimeframe=<?php echo $sel_time; ?>&fromdate=<?php echo $sel_fromdate; ?>&todate=<?php echo $sel_todate; ?>" method="get"  name="form1" id="form1" onsubmit="javscript:return dateselect();">
...
if(isset($_GET))
{
   ...
   // $myMessage='';
	...
	$sql="call sp_delivery_nse('".$exchange."','".$sel_martype."','".$sel_industry."','".$sel_sector."','".$sel_time."',
...
if (isset($_GET['page']) && is_numeric($_GET['page']))
      ...
      //  {
       ...
       // }
        ...
        {
        $i = $show_page - 1;
        $prev = "<a href=\"Delivery_volume.php?page=$i&id=$exchange&mymarkettype=$sel_martype&industry=$sel_industry&sector=$sel_sector&mytimeframe=$sel_time&fromdate=$sel_fromdate&todate=$sel_todate\"><strong>Prev |</strong></a>";
        $first = "<a href=\"Delivery_volume.php?page=1&id=$exchange&mymarkettype=$sel_martype&industry=$sel_industry&sector=$sel_sector&mytimeframe=$sel_time&fromdate=$sel_fromdate&todate=$sel_todate\"><strong>First |</strong></a>";
        }
        else {
...
if ($show_page < $total_pages) {
     $i = $show_page + 1;
     $next = "<a href=\"Delivery_volume.php?page=$i&id=$exchange&mymarkettype=$sel_martype&industry=$sel_industry&sector=$sel_sector&mytimeframe=$sel_time&fromdate=$sel_fromdate&todate=$sel_todate\"><strong>Next |</strong></a>";
     $last = "<a href=\"Delivery_volume.php?page=$total_pages&id=$exchange&mymarkettype=$sel_martype&industry=$sel_industry&sector=$sel_sector&mytimeframe=$sel_time&fromdate=$sel_fromdate&todate=$sel_todate\"><strong>Last |</strong></a>";
}
else {
