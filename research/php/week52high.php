...
<form action="week52high.php?id=<?php echo $exchange; ?>&mymarkettype=<?php echo $sel_martype; ?>&industry=<?php echo $sel_industry; ?>&sector=<?php echo $sel_sector; ?>" method="get"  name="form1" id="form1">
...
if(isset($_POST))
{
	...
	$sql="call sp_52_week_high('".$exchange."','".$sel_martype."','".$sel_industry."','".$sel_sector."')";
...
if (isset($_GET['page']) && is_numeric($_GET['page']))
      ...
      $prev = "<a href=\"week52high.php?page=$i&id=$exchange&mymarkettype=$sel_martype&industry=$sel_industry&sector=$sel_sector\"><strong>Prev |</strong></a>";
    $first = "<a href=\"week52high.php?page=1&id=$exchange&mymarkettype=$sel_martype&industry=$sel_industry&sector=$sel_sector\"><strong>First |</strong></a>";
        }
        else {
...
if ($show_page < $total_pages) {
  ...
  $next = "<a href=\"week52high.php?page=$i&id=$exchange&mymarkettype=$sel_martype&industry=$sel_industry&sector=$sel_sector\"><strong>Next |</strong></a>";
  $last = "<a href=\"week52high.php?page=$total_pages&id=$exchange&mymarkettype=$sel_martype&industry=$sel_industry&sector=$sel_sector\"><strong>Last |</strong></a>";
}
else {
