...
<form action="Price_Shockers.php?id=<?php echo $exchange; ?>&mymarkettype=<?php echo $sel_martype; ?>&industry=<?php echo $sel_industry; ?>&sector=<?php echo $sel_sector; ?>&tgl=<?php echo $sel_tgl; ?>" method="get" name="form1" id="form1" onsubmit="javscript:return dateselect();">
...
if(isset($_GET))
{
    ...
    $sql="call sp_price_shockers_nse('".$sel_martype."','".$sel_industry."','".$sel_sector."','".$tgl."')";
     ...
     { 
      ...
      //  }
       ...
       // }
        ...
        {
        $i = $show_page - 1;
        $prev = "<a href=\"Price_Shockers.php?page=$i&id=$exchange&mymarkettype=$sel_martype&industry=$sel_industry&sector=$sel_sector&tgl=$sel_tgl\"><strong>Prev |</strong></a>";
        $first = "<a href=\"Price_Shockers.php?page=1&id=$exchange&mymarkettype=$sel_martype&industry=$sel_industry&sector=$sel_sector&tgl=$sel_tgl\"><strong>First |</strong></a>";
        }
        else {
...
if ($show_page < $total_pages) {
     $i = $show_page + 1;
     $next = "<a href=\"Price_Shockers.php?page=$i&id=$exchange&mymarkettype=$sel_martype&industry=$sel_industry&sector=$sel_sector&tgl=$sel_tgl\"><strong>Next |</strong></a>";
     $last = "<a href=\"Price_Shockers.php?page=$total_pages&id=$exchange&mymarkettype=$sel_martype&industry=$sel_industry&sector=$sel_sector&tgl=$sel_tgl\"><strong>Last |</strong></a>";
}
else {
...
echo "</tr>";
    ...
    //$date=$sql_row["upload_date"];
                ...
                echo "<tr>";
                echo "<td id=\"id\" name=\"id\" bgcolor=\"F8F8F8\" align=\"left\" style=\"color:#004040; font-size:11px;\"><a href=\"#\" id=\"id\" name=\"id\" onclick=\"javascript:nse($nseid);\">" . mysql_result($result, $i, 'Symbol') . '</a></td>';
