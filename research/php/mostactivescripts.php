...
<!--
http://www.codeproject.com/KB/IP/webscheduler.aspx
http://www.phpjobscheduler.co.uk/
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
-->
<div style="position:absolute; top:19px; left:536px; color:green; font-size:13px"><b>Most Active Securities</b></div>
...
<form action="mostactivescripts.php?id=<?php echo $exchange; ?>&mymarkettype=<?php echo $sel_martype; ?>&industry=<?php echo $sel_industry; ?>&sector=<?php echo $sel_sector; ?>&mytimeframe=<?php echo $sel_time; ?>&fromdate=<?php echo $sel_fromdate; ?>&todate=<?php echo $sel_todate; ?>" method="get"  name="form1" id="form1" onsubmit="javscript:return dateselect();">
...
<table width="" border="0" cellspacing="1" cellpadding="3" align="left" style="font-size:13px;">
  <tr>
	...
	new tcal ({
      ...
      <table>
       <tr><td>  <div style="position:absolute; top:30px; font-color:white; left:570px;">
                 <input type="submit" value="GO" name="search" id="search" style=" font-weight:bold;
...
if (isset($_GET['page']) && is_numeric($_GET['page']))
  {
        ...
        {
                 //echo "<a href='mostactivescripts.php?page=$i'>$i</a> ";
        }
...
$prev = "<a href=\"mostactivescripts.php?page=$i&id=$exchange&mymarkettype=$sel_martype&industry=$sel_industry&sector=$sel_sector&mytimeframe=$sel_time&fromdate=$sel_fromdate&todate=$sel_todate\" ><strong>Prev |</strong></a>";
$first = "<a href=\"mostactivescripts.php?page=1&id=$exchange&mymarkettype=$sel_martype&industry=$sel_industry&sector=$sel_sector&mytimeframe=$sel_time&fromdate=$sel_fromdate&todate=$sel_todate\" ><strong>First |</strong></a>";
        }
        else {
...
if($show_page < $total_pages) {
     $i = $show_page + 1;
     $next = "<a href=\"mostactivescripts.php?page=$i&id=$exchange&mymarkettype=$sel_martype&industry=$sel_industry&sector=$sel_sector&mytimeframe=$sel_time&fromdate=$sel_fromdate&todate=$sel_todate\" ><strong>Next |</strong></a>";
     $last = "<a href=\"mostactivescripts.php?page=$total_pages&id=$exchange&mymarkettype=$sel_martype&industry=$sel_industry&sector=$sel_sector&mytimeframe=$sel_time&fromdate=$sel_fromdate&todate=$sel_todate\" ><strong>Last |</strong></a>";
}
else {
