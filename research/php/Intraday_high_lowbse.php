...
<form action="Intraday_high_lowbse.php?id=<?php echo $exchange; ?>&mypercentage=<?php echo $sel_per; ?>&mymarkettype=<?php echo $sel_martype; ?>&industry=<?php echo $sel_industry; ?>&sector=<?php echo $sel_sector; ?>&mytimeframe=<?php echo $sel_time; ?>&fromdate=<?php echo $sel_fromdate; ?>&todate=<?php echo $sel_todate; ?>&tgl=<?php echo $sel_tgl; ?>" method="get"  name="form1" id="form1" onsubmit="javscript:return dateselect();">
...
if(isset($_GET))
{
	...
	$sql="call sp_intraday_high_low_bse('".$sel_exchange."','".$sel_per."','".$sel_martype."','".$sel_industry."','".$sel_sector."','".$sel_tgl."','".$sel_time."',
...
if(!empty($total_results))
     { 
       ...
       // }
        ...
        {
        $i = $show_page - 1;
        $prev = "<a href=\"Intraday_high_lowbse.php?page=$i&id=$exchange&mypercentage=$sel_per&mymarkettype=$sel_martype&industry=$sel_industry&sector=$sel_sector&mytimeframe=$sel_time&fromdate=$sel_fromdate&todate=$sel_todate&tgl=$sel_tgl\"><strong>Prev |</strong></a>";
        $first = "<a href=\"Intraday_high_lowbse.php?page=1&id=$exchange&mypercentage=$sel_per&mymarkettype=$sel_martype&industry=$sel_industry&sector=$sel_sector&mytimeframe=$sel_time&fromdate=$sel_fromdate&todate=$sel_todate&tgl=$sel_tgl\"><strong>First |</strong></a>";
        }
        else {
...
if ($show_page < $total_pages) {
     $i = $show_page + 1;
     $next = "<a href=\"Intraday_high_lowbse.php?page=$i&id=$exchange&mypercentage=$sel_per&mymarkettype=$sel_martype&industry=$sel_industry&sector=$sel_sector&mytimeframe=$sel_time&fromdate=$sel_fromdate&todate=$sel_todate&tgl=$sel_tgl\"><strong>Next |</strong></a>";
     $last = "<a href=\"Intraday_high_lowbse.php?page=$total_pages&id=$exchange&mypercentage=$sel_per&mymarkettype=$sel_martype&industry=$sel_industry&sector=$sel_sector&mytimeframe=$sel_time&fromdate=$sel_fromdate&todate=$sel_todate&tgl=$sel_tgl\"><strong>Last |</strong></a>";
}
else {
