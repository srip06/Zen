...
<form action="volume_Shockers.php?id=<?php echo $exchange; ?>&mymarkettype=<?php echo $sel_martype; ?>&industry=<?php echo $sel_industry; ?>&sector=<?php echo $sel_sector; ?>&tgl=<?php echo $tgl; ?>" method="get" name="form1" id="form1" onsubmit="javscript:return dateselect();">
...
$sql="call sp_volume_shockers_nse('".$sel_martype."','".$sel_industry."','".$sel_sector."','".$sel_tgl."')";
	...
	if(!empty($total_results))
     {
      ...
      //  }
        ...
        {
        $i = $show_page - 1;
        $prev = "<a href=\"volume_Shockers.php?page=$i&id=$exchange&mymarkettype=$sel_martype&industry=$sel_industry&sector=$sel_sector&tgl=$sel_tgl\"><strong>Prev |</strong></a>";
        $first = "<a href=\"volume_Shockers.php?page=1&id=$exchange&mymarkettype=$sel_martype&industry=$sel_industry&sector=$sel_sector&tgl=$sel_tgl\"><strong>First |</strong></a>";
        }
        else {
...
if ($show_page < $total_pages) {
     $i = $show_page + 1;
     $next = "<a href=\"volume_Shockers.php?page=$i&id=$exchange&mymarkettype=$sel_martype&industry=$sel_industry&sector=$sel_sector&tgl=$sel_tgl\"><strong>Next |</strong></a>";
     $last = "<a href=\"volume_Shockers.php?page=$total_pages&id=$exchange&mymarkettype=$sel_martype&industry=$sel_industry&sector=$sel_sector&tgl=$sel_tgl\"><strong>Last |</strong></a>";
}
else {
