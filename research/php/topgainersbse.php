...
if(isset($_GET))
{
   ...
   $sql="call sp_topgainers_bse('".$exchange."','".$sel_per."','".$sel_martype."','".$sel_industry."','".$sel_sector."','".$sel_time."',
    ...
    if (isset($_GET['page']) && is_numeric($_GET['page']))
        ...
        {
        $i = $show_page - 1;
        $prev = "<a href=\"topgainersbse.php?page=$i&id=$exchange&mypercentage=$sel_per&mymarkettype=$sel_martype&industry=$sel_industry&sector=$sel_sector&mytimeframe=$sel_time&fromdate=$sel_fromdate&todate=$sel_todate\"><strong>Prev |</strong></a>";
        $first = "<a href=\"topgainersbse.php?page=1&id=$exchange&mypercentage=$sel_per&mymarkettype=$sel_martype&industry=$sel_industry&sector=$sel_sector&mytimeframe=$sel_time&fromdate=$sel_fromdate&todate=$sel_todate\"><strong>First |</strong></a>";
        }
       else {
...
{
     $i = $show_page + 1;
     $next = "<a href=\"topgainersbse.php?page=$i&id=$exchange&mypercentage=$sel_per&mymarkettype=$sel_martype&industry=$sel_industry&sector=$sel_sector&mytimeframe=$sel_time&fromdate=$sel_fromdate&todate=$sel_todate\"><strong>Next |</strong></a>";
     //$total_pages=9;
     $last = "<a href=\"topgainersbse.php?page=$total_pages&id=$exchange&mypercentage=$sel_per&mymarkettype=$sel_martype&industry=$sel_industry&sector=$sel_sector&mytimeframe=$sel_time&fromdate=$sel_fromdate&todate=$sel_todate\"><strong>Last |</strong></a>";
}
else
{
