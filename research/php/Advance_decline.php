...
<form method="get" action="Advance_decline.php?id=<?php echo $exchange; ?> &fromdate=<?php echo $sel_date; ?>"  name="form1" id="form1">
 ...
 if (isset($_GET['page']) && is_numeric($_GET['page']))
      ...
      //  }
       ...
       // }
        ...
        {
        $i = $show_page - 1;
        $prev = "<a href=\"Advance_decline.php?page=$i&id=$exchange&fromdate=$sel_date\"><strong>Prev |</strong></a>";
