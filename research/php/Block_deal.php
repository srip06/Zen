...
<!-- <!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd"> -->
	<div style="position:absolute; top:19px; left:608px; color:green; font-size:13px"><b>Block Deal</b></div>
...
if($exchange == 'nseblue')
{
$sql="select Upload_date from tbl_block_nse order by Upload_date desc limit 1";
}
if($exchange == 'bseblue')
{
$sql="select Upload_date from tbl_block_bse order by Upload_date desc limit 1";
}
...
if($exchange == 'nseblue')
    {
	$sql="call sp_block_nse('".$sel_time."','".$sel_fromdate."','".$sel_todate."')";
	}
else if($exchange == 'bseblue')
 {
	$sql="call sp_block_bse('".$sel_time."','".$sel_fromdate."','".$sel_todate."')";
	}
 ...
 if (isset($_GET['page']) && is_numeric($_GET['page']))
      ...
      //  }
        ...
        {
                 //echo "<a href='Block_deal.php?page=$i'>$i</a> ";
        }

                if($show_page > 1)
        {
        $i = $show_page - 1;
      $prev = "<a href=\"Block_deal.php?page=$i&id=$exchange&m><strong>Prev |</strong></a>";
        $first = "<a href=\"Block_deal.php?page=1\"><strong>First |</strong></a>";
        }
        else {
...
if ($show_page < $total_pages) {
     $i = $show_page + 1;
     $next = "<a href=\"Block_deal.php?page=$i&id=$exchange\"><strong>Next |</strong></a>";
     $last = "<a href=\"Block_deal.php?page=$total_pages&id=$exchange\"><strong>Last |</strong></a>";
}
else {
