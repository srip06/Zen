...
<form method="get" action="Demat_Auctionbse.php?id=<?php echo $exchange; ?> &date=<?php echo $sel_date; ?>"  name="form1" id="form1">
...
if(isset($_GET['date']))
	...
	$sel_date = $_GET['date'];
  	 ...
  	 $per_page = 20;
	$sql="call sp_demate_auction_bse('".$sel_date."')";
 ...
 if (isset($_GET['page']) && is_numeric($_GET['page']))
     ...
     //   }
        ...
        {
        $i = $show_page - 1;
        $prev = "<a href=\"Demat_Auctionbse.php?page=$i&id=$exchange&date=$sel_date\"><strong>Prev |</strong></a>";
        $first = "<a href=\"Demat_Auctionbse.php?page=1&id=$exchange&date=$sel_date\"><strong>First |</strong></a>";
        }
        else {
...
if ($show_page < $total_pages) {
     $i = $show_page + 1;
     $next = "<a href=\"Demat_Auctionbse.php?page=$i&id=$exchange&date=$sel_date\"><strong>Next |</strong></a>";
     $last = "<a href=\"Demat_Auctionbse.php?page=$total_pages&id=$exchange&date=$sel_date\"><strong>Last |</strong></a>";
}
else {
