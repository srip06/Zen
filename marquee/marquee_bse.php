...
{
window.open ("marqueelink.php?id="+id,
"mywindow","location=no,status=no,scrollbars=no,width=522,height=145,left=450,top=290,menubar=no,,toolbar=no,directories=no");
...
<?php
include_once('db.php');
$selectsqw = "call sp_scrolling_bse";
			...
			{		
				 ...
				 if ($img > 0 )
						...
						else
						{
							...
							$id=$rowqw['Id'];	
					//echo "&nbsp;" ."&nbsp;"."<a href=\"#\" name=\"id\" id=\"id\" onclick=\"javascript:link($id);\">".$rowqw['SC_NAME']."&nbsp;" ."&nbsp;".$rowqw['Close_price']."&nbsp;" ."&nbsp;"."&#40;
//" . $img."&#37;"."&#41;
					echo "&nbsp;" ."&nbsp;"."<span style=\"cursor:Hand; font-size:14px; font-weight:normal; color:#FFFFFF;\" name=\"id\" id=\"id\" onclick=\"javascript:link($id);\">".$rowqw['SC_NAME']."&nbsp;" ."&nbsp;".$rowqw['Close_price']."&nbsp;" ."&nbsp;"."&#40;
" . $img."&#37;"."&#41;
"."|"."</span>"."&nbsp;"."&nbsp;"."&nbsp;";
